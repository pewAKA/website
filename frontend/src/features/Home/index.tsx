...
const stackTags = ['React', 'TypeScript', 'Next.js', 'Sass', 'Ant Design', 'Axios', 'R3F']
    ...
    <div className="home-page">
      <section className="home-hero">
        <div className="home-hero__content">
          ...
          <div className="home-hero__actions">
            <Link className="home-action home-action--primary" href="/works">
              查看项目作品
            </Link>
            <Link className="home-action" href="/articles">
              阅读技术文章
            </Link>
          </div>
        ...
        <div className="home-hero__visual" aria-hidden="true">
          <div className="home-hero__visual-frame">
            <Image src="/hero.png" alt="" width={820} height={820} priority />
      ...
      <section className="home-directory">
        ...
        <div className="home-directory__grid">
          {hubLinks.map((item) => (
            <Link className="home-directory-card" key={item.path} href={item.path}>
